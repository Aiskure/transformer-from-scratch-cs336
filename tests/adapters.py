...
def run_transformer_lm(
    ...
    model = TransformerLM(vocab_size, context_length, d_model, num_heads,
                          d_ff, num_layers, rope_theta,
                          device=in_indices.device, dtype=torch.float32)

    # Load embeddings and final layers
    ...
    # Load each TransformerBlock layer
